    ...
    >
      ...
      >
        <Image
          ...
          className={`object-cover ${shouldReduceMotion ? '' : 'transform group-hover:scale-105 transition-all duration-[2s] ease-out grayscale-[0.2] group-hover:grayscale-0 opacity-90 group-hover:opacity-100'}`}
        />
